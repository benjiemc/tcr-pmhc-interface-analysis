Align TCR-pMHC based on holo structures.
  $ python -m tcr_pmhc_interface_analysis.apps.align_tcr_pmhcs -o test $TESTDIR/data/apo-holo
...
Align TCR-pMHC holo structures on CDR or pMHC
  $ python -m tcr_pmhc_interface_analysis.apps.align_tcr_pmhcs --log-level error --only-holo -o test-holo $TESTDIR/data/only-holo
